...
<body>
	<form:form action="/QuiltPiece/Create/rightRightTriangle" method="post" modelAttribute="newQuiltPiece">
		<p>
			<form:input type="hidden" value="${pattern_ID}" path="quiltPattern"/>
		</p>
	    <p>
	        <form:input type="hidden" value="rightRightTriangle" path="polygonName"/>
	    </p>
	    <p>
